    ...
    return (
        <div id="cloverleaf-page-container">
            ...
            <div className="content-container">
                ...
                <p className="text font-text">In business since 1946, The Clover Leaf is a small, family-owned business that had been using the same logo since their inception in the 40s, and needed a brand refresh to combine its multitude of offerings under one cohesive set of design guidelines. Additionally, in order to compete with big-box stores, it required a renewed online presence and refreshed marketing collateral to stay top-of-mind with customers and constantly drive in-store and online engagement.</p>
                <img src={formatPublicResourcePath("01.png")} alt="Old and new logo." />
                <p className="subtitle font-subtitle">THE APPROACH</p>
                <p className="text font-text">Every product in this small-town hobby store is centered around fun, and carrying that essence through to the logo and design collateral was imperative.  All of the branding, marketing, and UI design was approached with this fun freshness in mind, so that the new designs felt modern but approachable and friendly. One of the top goals for this project is to heavily push the idea that this is the customers’ friendly small-town business, its trustworthy, so you should shop here and support it like a friend (vs. going to a big box store).</p>
                ...
                <p className="text font-text">Custom illustrations are used throughout the advertising, print, and digital experience. The illustrations are all reminiscent of a children’s book, underpinning the idea that The Clover Leaf is centered first and foremost around fun, and highlighting that magical feeling of visiting a toy shop as a child.</p>
                ...
                <p className="text font-text">In a web-driven consumer world, maintaining a strong online presence is necessary to stay connected with customers. The Clover Leaf wanted to make their product offering understandable and accessible for customers through their online store, and to clearly display the wide variety of what the business offered.</p>
