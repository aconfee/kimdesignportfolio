    ...
    return (
        <div id="andpeonies-page-container">
            ...
            <div className="content-container">
                ...
                <p className="text font-text">The typography, color palette, and additional brand-marks were carefully created and selected to complement each other, supporting the soft, feminine aesthetic core to the & peonies brand.</p>
